...
/**
 * This class implements a generic binary string encodings.variable.It can be
 * used as a base class other binary string based classes (e.g., binary coded
...
public class Binary extends Variable {
	 ...
	 * 
	 * @param variable
	 *            The Binary encodings.variable to copy.
	 */
	 ...
	 * for examples the classes, <code>BinaryReal</code> and
	 * <code>BinaryInt<codes>. 
