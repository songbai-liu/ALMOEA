...
public class Statistics {
	 ...
	 * @param vector
	 * @param first
	 *            index of first position to consider in the vector
	 * @param last
	...
	public static Double calculateMedian(Vector vector, int first, int last) {
		...
		// System.out.println("size: " + size + "first: " + first + " last:  " +
		// last) ;
	...
	public static Double calculateIQR(Vector vector) {
		...
		if (vector.size() > 1) { // == 1 implies IQR = 0
			if (vector.size() % 2 != 0) {
				q3 = calculateMedian(vector, vector.size() / 2 + 1,
						vector.size() - 1);
				q1 = calculateMedian(vector, 0, vector.size() / 2 - 1);
				// System.out.println("Q1: [" + 0 + ", " + (vector.size()/2 - 1)
				// + "] = " + q1) ;
				// System.out.println("Q3: [" + (vector.size()/2+1) + ", " +
				// (vector.size()-1) + "]= " + q3) ;
			} else {
				...
				// System.out.println("Q1: [" + 0 + ", " + (vector.size()/2 - 1)
				// + "] = " + q1) ;
				// System.out.println("Q3: [" + (vector.size()/2) + ", " +
				// (vector.size()-1) + "]= " + q3) ;
			} // else
		} // if
