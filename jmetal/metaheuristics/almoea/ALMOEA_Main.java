	...
	public static void main(String[] args) throws JMException,
		...
		for(int fun=1;fun<=9;fun++){
		    ...
		    for(int i=0;i<runtimes;i++){
		    	algorithm = new ALMOEA(problem);
		    	// Algorithm parameters
		    	if(m == 2) {
	    			algorithm.setInputParameter("populationSize", 100);
		    		algorithm.setInputParameter("maxEvaluations", 100*10000);
				...
				parameters.put("CR_", 1.0);
				parameters.put("F_", 0.5);
		    	...
		    	// Result messages
		    	population.printObjectivesToFile("ALMOEA_"+problem.getNumberOfObjectives()+"Obj_"+problem.getName()+ "_" + problem.getNumberOfVariables() + "D_run"+(i+1)+".txt" );
