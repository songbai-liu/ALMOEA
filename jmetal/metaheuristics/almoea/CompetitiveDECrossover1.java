...
public class CompetitiveDECrossover1 {
    ...
    public CompetitiveDECrossover1(SolutionSet population, Problem problem){
    ...
    public SolutionSet doCrossover()throws JMException, ClassNotFoundException{
        ...
        /*Classification*/
        SolutionSet[] trainingSet = getClassifiedSet1();
    ...
    public SolutionSet reproduction(SolutionSet[] st) throws JMException, ClassNotFoundException {
        ...
        for (int i = 0; i < st[1].size(); i++) {
            ...
            int rdInt2 = PseudoRandom.randInt(0, st[1].size()-1);

            parents[0] = st[0].get(rdInt1);
            parents[1] = st[1].get(rdInt2);
            parents[2] = st[1].get(i);
            ...
            for (int j = 0; j < numVars; j++) {
                if (PseudoRandom.randDouble(0, 1) < CR || j == jrand) {
                    ...
                    value = xParent2.getValue(j) + F*(xParent0.getValue(j) - xParent2.getValue(j)) + F*(xParent0.getValue(j) - xParent1.getValue(j));
