...
public class InnovizedRepair {
    ...
    public InnovizedRepair(SolutionSet population, Problem problem){
    ...
    public InnovizedRepair(SolutionSet population, Problem problem, MLPModel currentMLPModel){
        this.population = population;
        this.problem = problem;
        this.numVars = problem.getNumberOfVariables();
        this.numObjs = problem.getNumberOfObjectives();
