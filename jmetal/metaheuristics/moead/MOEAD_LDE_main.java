    ...
    public static void main(String[] args) throws JMException,
        ...
        for(int fun=1;fun<=9;fun++){
            ...
            for(int i=0;i<runtimes;i++){
              ...
              population.printObjectivesToFile("MLDE_"+problem.getNumberOfObjectives()+"Obj_"+problem.getName()+ "_" + problem.getNumberOfVariables() + "D_run"+(i+1)+".txt" );
