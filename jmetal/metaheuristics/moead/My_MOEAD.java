...
public class My_MOEAD extends Algorithm {
 ...
 * Operators
 */
Operator crossover_,crossover2_;
Operator mutation_;
 ...
 *            Problem to solve
 */
public My_MOEAD(Problem problem) {
	super(problem);
...
public SolutionSet execute() throws JMException, ClassNotFoundException {
	...
	crossover2_ = operators_.get("crossover2"); // default: SBX crossover
