...
/**
 * Class to configure and execute the NSGA-II algorithm. The
 * experiments.settings are aimed at solving the mTSP problem.
 */
...
public class NSGAII_mTSP_main {
	 ...
	 *             Usage: - jmetal.metaheuristics.nsgaII.NSGAII_mTSP_main
	 */
	public static void main(String[] args) throws JMException,
		...
		// crossover =
		// CrossoverFactory.getCrossoverOperator("TwoPointsCrossover",
		// parameters);
