...
public class main1 {
    ...
    public static void main(String[] args) throws JMException,
        ...
        for(int fun=37;fun<=37;fun++){
            ...
            for(int i=0;i<runtimes;i++){
                algorithm = new NSGAII_ANN(problem);
                ...
                population.printObjectivesToFile("NSGAII_LDE_"+problem.getNumberOfObjectives()+"Obj_"+problem.getName()+ "_" + problem.getNumberOfVariables() + "D_run"+(i+1)+".txt" );
