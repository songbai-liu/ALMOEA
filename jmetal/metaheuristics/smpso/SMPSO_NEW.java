...
*/
public class SMPSO_NEW extends Algorithm {
 ...
 *            Problem to solve
 */
public SMPSO_NEW(Problem problem) {
	super(problem);
...
public SMPSO_NEW(Problem problem, Vector<Double> variables,
 ...
 *            Problem to solve
 */
public SMPSO_NEW(Problem problem, String trueParetoFront)
...
public SolutionSet execute() throws JMException, ClassNotFoundException {
	...
	// Crowding the leaders_ leader should be a non-dominated solution set!
