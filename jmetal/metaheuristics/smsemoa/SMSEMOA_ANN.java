...
import jmetal.metaheuristics.almoea.CompetitiveDECrossover;
 ...
 */
public class SMSEMOA_ANN extends Algorithm {
     ...
     */
    public SMSEMOA_ANN(Problem problem) {
        super(problem) ;
    ...
    public SolutionSet execute() throws JMException, ClassNotFoundException {
        ...
        //    offspringPopulation = new anncrossover1(population,problem_).doCrossover();
            ...
            if(PseudoRandom.randDouble(0.0,1.0) <0.1){
            ...
            while(front.size() <= remain && remain > 0){
        ...
        //ranking.getSubfront(0).printFeasibleFUN("FUN_SMSEMOA") ;
