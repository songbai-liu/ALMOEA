...
public class CrossoverFactory {
  ...
  public static Crossover getCrossoverOperator(String name, HashMap parameters) throws JMException {
    ...
    else if (name.equalsIgnoreCase("AdaptiveDECrossover"))
        return new AdaptiveDECrossover(parameters);
    else if (name.equalsIgnoreCase("SegmentalDECrossover"))
        return new SegmentalDECrossover(parameters);
    else if (name.equalsIgnoreCase("SegmentalSBXCrossover"))
        return new SegmentalSBXCrossover(parameters);
    else {
