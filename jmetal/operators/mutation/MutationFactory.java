...
public class MutationFactory {
	...
	public static Mutation getMutationOperator(String name, HashMap parameters)
		...
		else if (name.equalsIgnoreCase("GroupPolynomialMutation"))
			return new GroupPolynomialMutation(parameters);
		...
		else if (name.equalsIgnoreCase("SegmentalMutation"))
				return new SegmentalMutation(parameters);
		else {
