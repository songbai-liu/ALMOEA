 ...
 */
public class IMF4 extends Problem {
	/**
	 ...
	 */
	public IMF4(String solutionType) throws ClassNotFoundException {
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public IMF4(String solutionType, Integer numberOfVariables,
	...
	public void evaluate(Solution solution) throws JMException {
		...
		for (int i = 2; i < numberOfVariables_; i++)
			g += Math.pow((1+alph*(i+1)/numberOfVariables_)*x[i]-x[0], 2);
