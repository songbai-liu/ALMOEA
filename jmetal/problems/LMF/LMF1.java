...
public class LMF1 extends LMF{
	
	public LMF1(String solutionType, int numberOfVariables, int numberOfObjectives) {
	...
	public LMF1(int numberOfVariables, int numberOfObjectives, int type1, int type2, int type3, int type4) {
