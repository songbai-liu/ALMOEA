...
public class LMF10 extends LMF{
	
	public LMF10(String solutionType, int numberOfVariables, int numberOfObjectives) {
	...
	public LMF10(int numberOfVariables, int numberOfObjectives, int type1, int type2, int type3, int type4) {
