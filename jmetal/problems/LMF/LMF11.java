...
public class LMF11 extends LMF{
	
	public LMF11(String solutionType, int numberOfVariables, int numberOfObjectives) {
		super(solutionType, numberOfVariables, numberOfObjectives);
		problemName_ = "LMF11";
		gType_ = "LMF11";
		hType_ = "inverted_concave";
	}
	
	public LMF11(int numberOfVariables, int numberOfObjectives, int type1, int type2, int type3, int type4) {
