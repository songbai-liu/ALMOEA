...
public class LMF12 extends LMF{
	
	public LMF12(String solutionType, int numberOfVariables, int numberOfObjectives) {
		super(solutionType, numberOfVariables, numberOfObjectives);
		problemName_ = "LMF12";
		gType_ = "LMF12";
		hType_ = "inverted_linear";
	}
	
	public LMF12(int numberOfVariables, int numberOfObjectives, int type1, int type2, int type3, int type4) {
