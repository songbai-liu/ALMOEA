...
public class LMF2 extends LMF{
	
	public LMF2(String solutionType, int numberOfVariables, int numberOfObjectives) {
	...
	public LMF2(int numberOfVariables, int numberOfObjectives, int type1, int type2, int type3, int type4) {
