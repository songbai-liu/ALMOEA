...
public class LMF3 extends LMF{
	
	public LMF3(String solutionType, int numberOfVariables, int numberOfObjectives) {
	...
	public LMF3(int numberOfVariables, int numberOfObjectives, int type1, int type2, int type3, int type4) {
