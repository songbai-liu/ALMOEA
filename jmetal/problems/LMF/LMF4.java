...
public class LMF4 extends LMF{
	
	public LMF4(String solutionType, int numberOfVariables, int numberOfObjectives) {
	...
	public LMF4(int numberOfVariables, int numberOfObjectives, int type1, int type2, int type3, int type4) {
