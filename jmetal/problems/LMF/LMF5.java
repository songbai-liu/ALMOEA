...
public class LMF5 extends LMF{
	
	public LMF5(String solutionType, int numberOfVariables, int numberOfObjectives) {
	...
	public LMF5(int numberOfVariables, int numberOfObjectives, int type1, int type2, int type3, int type4) {
