...
public class LMF6 extends LMF{
	
	public LMF6(String solutionType, int numberOfVariables, int numberOfObjectives) {
	...
	public LMF6(int numberOfVariables, int numberOfObjectives, int type1, int type2, int type3, int type4) {
