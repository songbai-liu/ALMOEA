...
public class LMF7 extends LMF{
	
	public LMF7(String solutionType, int numberOfVariables, int numberOfObjectives) {
	...
	public LMF7(int numberOfVariables, int numberOfObjectives, int type1, int type2, int type3, int type4) {
