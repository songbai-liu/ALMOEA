...
public class LMF9 extends LMF{
	
	public LMF9(String solutionType, int numberOfVariables, int numberOfObjectives) {
	...
	public LMF9(int numberOfVariables, int numberOfObjectives, int type1, int type2, int type3, int type4) {
