...
public class LSMOP1 extends LSMOP {
	 ...
	 */
	public LSMOP1(String solutionType) throws ClassNotFoundException {
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public LSMOP1(String solutionType, Integer numberOfVariables,
		...
		for(int i = 0; i < numberOfObjectives_; i++){
			...
			sublen[i] = (int)Math.floor((c[i]/sumC)*(numberOfVariables_-numberOfObjectives_+1)/nk);
	...
	public void evaluate(Solution solution) throws JMException {
		...
		if(dim != numberOfVariables_) {
			System.out.println("LSMOP1: Recent Dim = "+ dim);
			System.out.println("LSMOP1: The Preset numberOfVariables = "+ numberOfVariables_);
		}
