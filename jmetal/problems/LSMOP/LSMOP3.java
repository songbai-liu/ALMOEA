...
public class LSMOP3 extends LSMOP {
	 ...
	 */
	public LSMOP3(String solutionType) throws ClassNotFoundException {
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public LSMOP3(String solutionType, Integer numberOfVariables,
	...
	public void evaluate(Solution solution) throws JMException {
		...
		if(dim != numberOfVariables_) {
			System.out.println("LSMOP3: Recent Dim = "+ dim);
			System.out.println("LSMOP3: The Preset numberOfVariables = "+ numberOfVariables_);
		}
