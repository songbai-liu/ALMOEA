...
public class LSMOP5 extends LSMOP {
	 ...
	 */
	public LSMOP5(String solutionType) throws ClassNotFoundException {
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public LSMOP5(String solutionType, Integer numberOfVariables,
	...
	public void evaluate(Solution solution) throws JMException {
		...
		if(dim != numberOfVariables_) {
			System.out.println("LSMOP5: Recent Dim = "+ dim);
			System.out.println("LSMOP5: The Preset numberOfVariables = "+ numberOfVariables_);
		}
