...
public class LSMOP6 extends LSMOP {
	 ...
	 */
	public LSMOP6(String solutionType) throws ClassNotFoundException {
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public LSMOP6(String solutionType, Integer numberOfVariables,
	...
	public void evaluate(Solution solution) throws JMException {
		...
		if(dim != numberOfVariables_) {
			System.out.println("LSMOP6: Current Dim = "+ dim);
			System.out.println("LSMOP6: The Preset numberOfVariables = "+ numberOfVariables_);
		}
