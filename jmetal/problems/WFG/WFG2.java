...
/**
 * This class implements the WFG2 problem Reference: Simon Huband, Luigi Barone,
...
public class WFG2 extends WFG {
	...
	/**
	 * Creates a default WFG2 instance with 2 position-related parameters 4
	...
	public float[] evaluate(float[] z) {
		...
		result[M_ - 1] = D_ * x[M_ - 1] + S_[M_ - 1]
				* (new Shapes()).disc(x, 5, (float) 1.0, (float) 1.0);
