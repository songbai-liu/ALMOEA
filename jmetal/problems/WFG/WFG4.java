...
/**
 * This class implements the WFG4 problem Reference: Simon Huband, Luigi Barone,
...
public class WFG4 extends WFG {
	...
	/**
	 * Creates a default WFG4 with 2 position-related parameter, 4
	 * distance-related parameter and 2 objectives
	 * 
	 * @param solutionType
	...
	public float[] t1(float[] z, int k) {
		...
		for (int i = 0; i < z.length; i++) {
			result[i] = (new Transformations()).s_multi(z[i], 30, 10,
					(float) 0.35);
		}
