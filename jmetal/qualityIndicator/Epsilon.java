...
public class Epsilon {
	...
	int dim_;
	/*
	 * obj_[i]=0 means objective i is to be minimized. This code always assume
	...
	/**
	 * Returns the additive-epsilon value of the paretoFront. This method call
	 * to the calculate epsilon-indicator one
	 */
	public static void main(String[] args) {
		...
		if (args.length < 2) {
			System.err
					.println("Error using Epsilon. Type: \n java AdditiveEpsilon "
							+ "<FrontFile>"
							+ "<TrueFrontFile> + <numberOfObjectives>");
			System.exit(1);
		}
		...
		ind_value = qualityIndicator.epsilon(trueFront, solutionFront,
				new Integer(args[2]));
