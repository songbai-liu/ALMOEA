...
/**
 * This class implements the generational distance indicator. It can be used
 * also as a command line by typing: "java
 * jmetal.qualityIndicator.GenerationalDistance <solutionFrontFile>
...
public class GenerationalDistance {
	...
	public double generationalDistance(double[][] front,
		...
		/*maximumValue = utils_.getMaximumValues(trueParetoFront,
				numberOfObjectives);
		minimumValue = utils_.getMinimumValues(trueParetoFront,
				numberOfObjectives);
	...
	public double generationalDistance(SolutionSet prePopulation,
			SolutionSet population, int numberOfObjectives) {
		double[][] front = utils_.readFront(prePopulation);
		double[][] trueParetoFront = utils_.readFront(population);
	...
	public static void main(String args[]) {
		...
		double value = qualityIndicator.generationalDistance(solutionFront,
