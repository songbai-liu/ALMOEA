...
*/
public double cec_IGD(double [][] front, double [][] trueParetoFront, int numberOfObjectives) {
...
getIGD_M qualityIndicator = new getIGD_M();
...
double value = qualityIndicator.cec_IGD(
		                                 solutionFront,
		                                 trueFront,
        new Integer(args[2]));
