...
/**
 * Created with IntelliJ IDEA. User: antelverde Date: 08/07/13 Time: 16:46 To
...
public class AvlTreeTest {
	...
	public void testCompareNodes() throws Exception {
		...
		assertEquals("testCompareNodes", -1,
				avlTree_.compareNodes(node1, node2));
	...
	/*
	 * @Test public void testInsertingTheFirstElement() throws Exception {
	...
	public void testInsertingRightAndLeftElementsJustAfterTop()
		...
		assertEquals("testInsertingSecondSmallerElement", -1,
				avlTree_.searchClosestNode(nodeLeft));
		assertEquals("testInsertingSecondSmallerElement", node,
				nodeLeft.getClosestNode());
		assertEquals("testInsertingSecondSmallerElement", +1,
				avlTree_.searchClosestNode(nodeRight));
		assertEquals("testInsertingSecondSmallerElement", node,
				nodeRight.getClosestNode());
		assertEquals("testInsertingSecondSmallerElement", 0,
				avlTree_.searchClosestNode(node));
		...
		assertEquals("testInsertingSecondSmallerElement", -1,
				avlTree_.searchClosestNode(nodeRightLeft));
		assertEquals("testInsertingSecondSmallerElement", nodeRight,
				nodeRightLeft.getClosestNode());

		AvlNode<Integer> nodeLeftRight = new AvlNode<Integer>(5);
		assertEquals("testInsertingSecondSmallerElement", 1,
				avlTree_.searchClosestNode(nodeLeftRight));
		assertEquals("testInsertingSecondSmallerElement", nodeLeft,
				nodeLeftRight.getClosestNode());

		String tree = " | 6 | 4 | 9";
		assertEquals("testInsertingSecondSmallerElement", tree,
				avlTree_.toString());
	}
	...
	public void testHeightAndBalanceOfASimpleBalancedTree() throws Exception {
		...
		assertEquals("testHeightOfASimpleBalancedTree", 0,
				avlTree_.getBalance(node1));
		...
		assertEquals("testHeightOfASimpleBalancedTree", -1,
				avlTree_.getBalance(node1));
		assertEquals("testHeightOfASimpleBalancedTree", 0,
				avlTree_.getBalance(node2));
		...
		assertEquals("testHeightOfASimpleBalancedTree", -1,
				avlTree_.getBalance(node1));
		assertEquals("testHeightOfASimpleBalancedTree", 0,
				avlTree_.getBalance(node5));

		String tree = " | 7 | 4 | 3 | 5 | 9";
		assertEquals("testHeightOfASimpleBalancedTree", tree,
				avlTree_.toString());
	}
	...
	public void testInsertingLeftLeftNodeAndRebalance() throws Exception {
		...
		assertEquals("testInsertingLeftLeftNodeAndRebalance", 0,
				node2.getHeight());
		assertEquals("testInsertingLeftLeftNodeAndRebalance", 1,
				node1.getHeight());
		assertEquals("testInsertingLeftLeftNodeAndRebalance", -1,
				avlTree_.getBalance(node1));
		assertEquals("testInsertingLeftLeftNodeAndRebalance", 0,
		...
		avlTree_.insertAvlNode(node3);
		assertEquals("testInsertingLeftLeftNodeAndRebalance", node2,
				avlTree_.getTop());
		assertEquals("testInsertingLeftLeftNodeAndRebalance", node3,
				node2.getLeft());
		assertEquals("testInsertingLeftLeftNodeAndRebalance", node1,
				node2.getRight());

		assertEquals("testInsertingLeftLeftNodeAndRebalance", 1, avlTree_
				.getTop().getHeight());
		assertEquals("testInsertingLeftLeftNodeAndRebalance", 0, avlTree_
				.getTop().getLeft().getHeight());
		assertEquals("testInsertingLeftLeftNodeAndRebalance", 0, avlTree_
				.getTop().getRight().getHeight());
		assertEquals("testInsertingLeftLeftNodeAndRebalance", -1,
				avlTree_.height(node1.getLeft()));
		assertEquals("testInsertingLeftLeftNodeAndRebalance", -1,
				avlTree_.height(node1.getRight()));
		assertEquals("testInsertingLeftLeftNodeAndRebalance", -1,
				avlTree_.height(node3.getLeft()));
		assertEquals("testInsertingLeftLeftNodeAndRebalance", -1,
				avlTree_.height(node3.getRight()));

		String tree = " | 4 | 3 | 7";
		assertEquals("testInsertingLeftLeftNodeAndRebalance", tree,
				avlTree_.toString());
	}
	...
	public void testInsertingRightRightNodeAndRebalance() throws Exception {
		...
		assertEquals("testInsertingRightRightNodeAndRebalance", 0,
				node2.getHeight());
		assertEquals("testInsertingRightRightNodeAndRebalance", 1,
				node1.getHeight());
		assertEquals("testInsertingRightRightNodeAndRebalance", 1,
				avlTree_.getBalance(node1));
		assertEquals("testInsertingRightRightNodeAndRebalance", 0,
		...
		avlTree_.insertAvlNode(node3);
		assertEquals("testInsertingRightRightNodeAndRebalance", node2,
				avlTree_.getTop());
		assertEquals("testInsertingRightRightNodeAndRebalance", node1,
				node2.getLeft());
		assertEquals("testInsertingRightRightNodeAndRebalance", node3,
				node2.getRight());

		assertEquals("testInsertingRightRightNodeAndRebalance", 1, avlTree_
				.getTop().getHeight());
		assertEquals("testInsertingRightRightNodeAndRebalance", 0, avlTree_
				.getTop().getLeft().getHeight());
		assertEquals("testInsertingRightRightNodeAndRebalance", 0, avlTree_
				.getTop().getRight().getHeight());
		assertEquals("testInsertingRightRightNodeAndRebalance", -1,
		...
		String tree = " | 10 | 7 | 14";
		assertEquals("testInsertingRightRightNodeAndRebalance", tree,
				avlTree_.toString());
	}
	...
	public void testInserting7_8_9_10_11() throws Exception {
		...
		assertEquals("testInserting7_8_9_10_11", 2, avlTree_.getTop()
				.getHeight());
	...
	public void testInsertingLeftRightNodeAndRebalance() throws Exception {
		...
		assertEquals("testInsertingLeftRightNodeAndRebalance", node3,
				avlTree_.getTop());
		assertEquals("testInsertingLeftRightNodeAndRebalance", node2,
				node3.getLeft());
		assertEquals("testInsertingLeftRightNodeAndRebalance", node1,
				node3.getRight());

		assertEquals("testInsertingLeftRightNodeAndRebalance", 1, avlTree_
				.getTop().getHeight());
		assertEquals("testInsertingLeftRightNodeAndRebalance", 0, avlTree_
				.getTop().getLeft().getHeight());
		assertEquals("testInsertingLeftRightNodeAndRebalance", 0, avlTree_
				.getTop().getRight().getHeight());
		assertEquals("testInsertingLeftRightNodeAndRebalance", -1,
				avlTree_.height(node2.getLeft()));
		assertEquals("testInsertingLeftRightNodeAndRebalance", -1,
				avlTree_.height(node2.getRight()));
		assertEquals("testInsertingLeftRightNodeAndRebalance", -1,
				avlTree_.height(node1.getLeft()));
		assertEquals("testInsertingLeftRightNodeAndRebalance", -1,
				avlTree_.height(node1.getRight()));
		...
		String tree = " | 3 | 2 | 7";
		assertEquals("testInsertingLeftRightNodeAndRebalance", tree,
				avlTree_.toString());
	}
	...
	public void testInsertingRightLeftNodeAndRebalance() throws Exception {
		...
		assertEquals("testInsertingRightLeftNodeAndRebalance", node3,
				avlTree_.getTop());
		assertEquals("testInsertingRightLeftNodeAndRebalance", node1,
				node3.getLeft());
		assertEquals("testInsertingRightLeftNodeAndRebalance", node2,
				node3.getRight());

		assertEquals("testInsertingRightLeftNodeAndRebalance", 1, avlTree_
				.getTop().getHeight());
		assertEquals("testInsertingRightLeftNodeAndRebalance", 0, avlTree_
				.getTop().getLeft().getHeight());
		assertEquals("testInsertingRightLeftNodeAndRebalance", 0, avlTree_
				.getTop().getRight().getHeight());
		assertEquals("testInsertingRightLeftNodeAndRebalance", -1,
				avlTree_.height(node2.getLeft()));
		assertEquals("testInsertingRightLeftNodeAndRebalance", -1,
				avlTree_.height(node2.getRight()));
		assertEquals("testInsertingRightLeftNodeAndRebalance", -1,
		...
		String tree = " | 8 | 7 | 9";
		assertEquals("testInsertingRightLeftNodeAndRebalance", tree,
				avlTree_.toString());
	}
	...
	public void testSearchNode() throws Exception {
		...
		assertEquals("testSearchNode", (Integer) 2,
				avlTree_.searchNode(new AvlNode<Integer>(2)).getItem());
	...
	public void testFindSuccessor() throws Exception {
		...
		assertEquals("testFindSuccessor", avlTree_.search(10),
				avlTree_.findSuccessor(node));
		node = avlTree_.search(10);
		assertEquals("testFindSuccessor", avlTree_.search(12),
				avlTree_.findSuccessor(node));
		node = avlTree_.search(14);
		assertEquals("testFindSuccessor", avlTree_.search(20),
				avlTree_.findSuccessor(node));
	...
	public void testDeletingLeafNodes() throws Exception {
		...
		assertEquals("testDeletingLeafNodes", " | 7 | 2 | 9 | 8",
				avlTree_.toString());
		...
		assertEquals("testDeletingLeafNodes", " | 7 | 2 | 9",
				avlTree_.toString());
	...
	public void testDeletingNodesWithOneLeaf() throws Exception {
		...
		avlTree_.delete(2);
		assertEquals("testDeletingNodesWithOneLeaf", node3.getItem(), node1
				.getLeft().getItem());
		assertEquals("testDeletingNodesWithOneLeaf", null, node3.getRight());
		assertEquals("testDeletingNodesWithOneLeaf", 0, node3.getHeight());
		assertEquals("testDeletingNodesWithOneLeaf", 2, avlTree_.getTop()
				.getHeight());
		assertEquals("testDeletingNodesWithOneLeaf", " | 7 | 3 | 9 | 8",
				avlTree_.toString());

		avlTree_.delete(9);
		assertEquals("testDeletingNodesWithOneLeaf", node2.getItem(), node1
				.getRight().getItem());
		assertEquals("testDeletingNodesWithOneLeaf", null, node2.getLeft());
		assertEquals("testDeletingNodesWithOneLeaf", 0, node2.getHeight());
		assertEquals("testDeletingNodesWithOneLeaf", 1, avlTree_.getTop()
				.getHeight());
		assertEquals("testDeletingNodesWithOneLeaf", " | 7 | 3 | 8",
				avlTree_.toString());
	}
	...
	public void testDeletingNodesWithTwoLeaves() throws Exception {
		...
		assertEquals("testDeletingNodesWithTwoLeaves", expected,
				avlTree_.toString());

		avlTree_.delete(12);
		node = avlTree_.search(8);
		assertEquals("testDeletingNodesWithTwoLeaves", 14, node.getRight()
				.getItem());
		assertEquals("testDeletingNodesWithTwoLeaves",
				" | 20 | 8 | 4 | 14 | 10 | 22 | 24", avlTree_.toString());

		avlTree_.delete(8);
		assertEquals("testDeletingNodesWithTwoLeaves", 10, avlTree_.getTop()
				.getLeft().getItem());
		assertEquals("testDeletingNodesWithTwoLeaves",
				" | 20 | 10 | 4 | 14 | 22 | 24", avlTree_.toString());
	}
	...
	public void testDeletingAndRebalancing() throws Exception {
		...
		assertEquals("testDeletingDeepLeafNode", 3, avlTree_.getTop()
				.getHeight());

		avlTree_.delete(22);
		// node = avlTree_.search(8) ;
		assertEquals("testDeletingDeepLeafNode", 12, (int) avlTree_.getTop()
				.getItem());
		assertEquals("testDeletingDeepLeafNode", avlTree_.search(8), avlTree_
				.getTop().getLeft());
		assertEquals("testDeletingDeepLeafNode", avlTree_.search(20), avlTree_
				.getTop().getRight());
	}
	...
	public void testDeletingTopNode() throws Exception {
		...
		assertEquals("testDeletingTopNode",
				" | 12 | 8 | 4 | 10 | 22 | 14 | 24", avlTree_.toString());

		/*
		 * assertEquals("testDeletingDeepLeafNode", 12,
		 * (int)avlTree_.getTop().getItem());
		 * assertEquals("testDeletingDeepLeafNode", avlTree_.search(8),
		 * avlTree_.getTop().getLeft());
		 * assertEquals("testDeletingDeepLeafNode", avlTree_.search(20),
		 * avlTree_.getTop().getRight());
		 */
	}
}
