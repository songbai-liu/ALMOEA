...
public class AdaptiveGrid {
	 ...
	 * 
	 * @param solutionSet
	 *            The <code>SolutionSet</code> considered.
	 */
	 ...
	 * <code>SolutionSet</code>. <b>REQUIRE</b> The grid limits must have been
	 ...
	 * 
	 * @param solution
	 *            <code>Solution</code> considered to update the grid.
	 * @param solutionSet
	 *            <code>SolutionSet</code> used to update the grid.
	 */
	...
	public void removeSolution(int location) {
		...
		// If hypercubes[location] now becomes to zero, then update ocupped
		// hypercubes
