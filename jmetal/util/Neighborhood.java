	...
	public Neighborhood(int solutionSetSize) {
		...
		for (int ind = 0; ind < solutionSetSize_; ind++) {
			...
			if (ind > rowSize_ - 1) {
				...
				structure_[ind][0][Row.N.ordinal()] = (ind - rowSize_ + solutionSetSize)
						% solutionSetSize;
			}
			...
			// South neigbors
			structure_[ind][0][Row.S.ordinal()] = (ind + rowSize_)
					% solutionSetSize;
		}

		for (int ind = 0; ind < solutionSetSize_; ind++) {
			structure_[ind][0][Row.NE.ordinal()] = structure_[structure_[ind][0][Row.N
					.ordinal()]][0][Row.E.ordinal()];
			structure_[ind][0][Row.NW.ordinal()] = structure_[structure_[ind][0][Row.N
					.ordinal()]][0][Row.W.ordinal()];
			structure_[ind][0][Row.SE.ordinal()] = structure_[structure_[ind][0][Row.S
					.ordinal()]][0][Row.E.ordinal()];
			structure_[ind][0][Row.SW.ordinal()] = structure_[structure_[ind][0][Row.S
					.ordinal()]][0][Row.W.ordinal()];
		}
	} // Neighborhood
