 ...
 */
public class NumberOfViolatedConstraintComparator implements
	...
	public int compare(Object o1, Object o2) {
		...
		if (solution1.getNumberOfViolatedConstraint() < solution2
				.getNumberOfViolatedConstraint()) {
			return -1;
		} else if (solution2.getNumberOfViolatedConstraint() < solution1
				.getNumberOfViolatedConstraint()) {
			return 1;
		}
	...
	/**
	 * Returns true if solutions s1 and/or s2 violates a number n > 0 of
	 * constraints
	 */
