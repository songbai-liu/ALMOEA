...
public class BLXAlphaCrossoverOffspring extends Offspring {
	...
	private BLXAlphaCrossoverOffspring(double crossoverProbability, double alpha)
			throws JMException {
		HashMap parameters;
		...
		crossover_ = CrossoverFactory.getCrossoverOperator("BLXAlphaCrossover",
				parameters);
	...
	public Solution getOffspring(SolutionSet solutionSet) {
		...
		try {
			...
			Logger.getLogger(BLXAlphaCrossoverOffspring.class.getName()).log(
