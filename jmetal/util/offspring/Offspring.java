...
public class Offspring {
	...
	/**
	 * Return on offspring from a solution set, indicating the selection
	 * operator
	 * 
	 * @param solutionSet
	 * @return the offspring
	 */
	public Solution getOffspring(SolutionSet solutionSet, int numberOfParents,
			int index, Selection selectionOperator) {
		Logger.getLogger(Offspring.class.getName()).log(Level.SEVERE,
	...
	/**
	 * Return on offspring from a solution set and the index of the current
	 * individual
	 * 
	 * @param solutionSet
	 * @param solution
	...
	public Solution getOffspring(SolutionSet solutionSet1,
			SolutionSet solutionSet2, int index) {
		Logger.getLogger(Offspring.class.getName()).log(Level.SEVERE,
				"method not implemented");
		return null;
	}
