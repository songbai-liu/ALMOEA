...
public class XReal {
	...
	public double getValue(int index) throws JMException {
		if ((type_.getClass() == RealSolutionType.class)
			...
			Configuration.logger_
					.severe("jmetal.util.wrapper.XReal.getValue, solution type "
							+ type_ + "+ invalid");
		}
		return 0.0;
	}
	...
	public void setValue(int index, double value) throws JMException {
		if (type_.getClass() == RealSolutionType.class)
			...
			Configuration.logger_
					.severe("jmetal.util.wrapper.XReal.setValue, solution type "
							+ type_ + "+ invalid");
	} // setValue
	...
	public double getLowerBound(int index) throws JMException {
		if ((type_.getClass() == RealSolutionType.class)
			...
			return ((ArrayReal) (solution_.getDecisionVariables()[0]))
					.getLowerBound(index);
		else if (type_.getClass() == ArrayRealAndBinarySolutionType.class)
			return ((ArrayReal) (solution_.getDecisionVariables()[0]))
					.getLowerBound(index);
			...
			Configuration.logger_
					.severe("jmetal.util.wrapper.XReal.getLowerBound, solution type "
							+ type_ + "+ invalid");
	...
	public double getUpperBound(int index) throws JMException {
		if ((type_.getClass() == RealSolutionType.class)
			...
			Configuration.logger_
					.severe("jmetal.util.wrapper.XReal.getUpperBound, solution type "
							+ type_ + "+ invalid");
	...
	public int getNumberOfDecisionVariables() {
		if ((type_.getClass() == RealSolutionType.class)
			...
			Configuration.logger_
					.severe("jmetal.util.wrapper.XReal.size, solution type "
							+ type_ + "+ invalid");
		return 0;
